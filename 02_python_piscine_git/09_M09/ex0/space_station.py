...
def main():
    ...
    try:
        valid_test = SpaceStation.model_validate({
            ...
            "is_operational": True,
            "notes": "Un regiment de fromage blanc"
        })
        ...
        print(
            "Status: "
            f"{'Operational' if valid_test.is_operational else 'Offline'}")
    ...
    try:
        invalid = SpaceStation.model_validate({
                ...
                "name": "Lt. ReblochonQuiAEteOublieAuFondDuFrigo",
                "crew_size": 50,
                "power_level": 80.5,
                "oxygen_level": 120.3,
                "last_maintenance": "2024-01-15",
        ...
        print(
            "Status: "
            f"{'Operational' if invalid.is_operational else 'Offline'}")
    except ValidationError as e:
        print("Expected validation error:")
        for error in e.errors():
            print(error["msg"])
